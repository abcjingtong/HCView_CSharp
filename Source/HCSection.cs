...
namespace HC.View
{
    ...
    public class HCCustomSection : HCObject
    {
        ...
        public virtual void MouseDown(MouseEventArgs e)
        {
            ...
            PaperCoordToData(FActivePageIndex, FActiveData, ref vX, ref vY, !FActiveData.SelectExists());
        ...
        {
            int vFmtHeightInc = -1, vFmtOffset = 0;
            ...
            ref int vPageIndex, ref int vPageDataFmtTop, ref int vPageDataFmtBottom)
        {
            ...
            if (vSuplus != 0)
            {
                for (int i = ADrawItemNo + 1; i < FPage.DrawItems.Count; i++)
